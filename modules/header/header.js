...
if (innerWidth < 768) { //  x < 768
    ...
    headerElement.append(logotypeSVGElement, menuButtonElement);
}
else { // x >= 768
    if (innerWidth < 1152) { //  1152 > x >= 768
        ...
        headerElement.append(logotypeSVGElement, siteNavigationElement, authorizationElement);
    ...
    if (innerWidth < 768) { //  x < 768
        ...
        if (innerWidth < 1152) { //  1152 > x >= 768
            ...
            if (currentWindowWidth < 768) {
                ...
                headerElement.style.gridTemplateColumns = 'max-content repeat(2, minmax(min-content, max-content))';
                headerElement.append(siteNavigationElement, authorizationElement);
            }
            else {
                if (currentWindowWidth < 1152) {
                    currentWindowWidth = innerWidth;
