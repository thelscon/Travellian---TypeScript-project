...
const fontPlayfairRegular = new FontFace (
    'Playfair Display' ,
    'url(./fonts/PlayfairDisplay/400/playfair-display-regular.woff2)' ,
    {
        weight : '400' ,
    }
)
...
const fontRubikRegular = new FontFace (
    'Rubik' ,
    'url(./fonts/Rubik/400/rubik-regular.woff2)' ,
    {
        weight : '400'
    }
)
