...
const menuButtonImagePath = document.createElementNS ('http://www.w3.org/2000/svg' , 'path')
menuButtonImagePath.setAttribute ('d' , 'M1.29167 2.58333C0.716375 2.58333 0.25 2.11696 0.25 1.54167C0.25 0.966375 0.716375 0.5 1.29167 0.5H36.7083C37.2835 0.5 37.75 0.966375 37.75 1.54167C37.75 2.11696 37.2835 2.58333 36.7083 2.58333H1.29167ZM1.29167 13C0.716375 13 0.25 12.5335 0.25 11.9583C0.25 11.3831 0.716375 10.9167 1.29167 10.9167H36.7083C37.2835 10.9167 37.75 11.3831 37.75 11.9583C37.75 12.5335 37.2835 13 36.7083 13H1.29167ZM1.29167 23.4167C0.716375 23.4167 0.25 22.9502 0.25 22.375C0.25 21.7998 0.716375 21.3333 1.29167 21.3333H36.7083C37.2835 21.3333 37.75 21.7998 37.75 22.375C37.75 22.9502 37.2835 23.4167 36.7083 23.4167H1.29167Z')
menuButtonImagePath.setAttribute ('fill' , 'white')
...
menuButton.style.background = `url('data:image/svg+xml, ${menuButtonImage.outerHTML}') center no-repeat`
...
mainElementForm.prepend (
    mainElementFormDestination ,
    mainElementFormPerson ,
    mainElementFormCheckIn ,
    mainElementFormCheckOut ,
    mainElementFormBookNow
)
